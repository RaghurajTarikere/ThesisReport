...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{InterfaceHelpersUML.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{InterfaceHelperImpl.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{OperationStructsUML.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{EventEmitterPortUML.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{EventReceiverPortUML.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{RequiredInterfacePort1Impl.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{RequiredInterfacePort2Impl.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{ProvidedInterfacePort1Impl.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{ProvidedInterfacePort2Impl.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{ProvidedInterfacePortImpl.pdf}
	\caption{Code excerpt from the generated code for operation \texttt{OperationAdd} access in \texttt{Provided\allowbreak Interface\allowbreak Port1} which is called asynchronously}
